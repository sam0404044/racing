...
export const STAGE2_COMMAND_CARDS = {
  ...
  laneRhythm:    { type:"laneRhythm",    cardClass:"action", name:"換道節奏", speedValue:15, note:"加速後換道、棄1張指令牌", canChangeLane:true, discardOnPlay:1, color:"red" },
  nitro:         { type:"nitro",         cardClass:"action", name:"氮氣噴射", speedValue:60, note:"棄1張指令牌", discardOnPlay:1, color:"red" },
